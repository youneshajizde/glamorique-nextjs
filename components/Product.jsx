...
function Product({ name, brand, img, btn }) {
  ...
  return (
    <div className="relative w-[200px]  rounded-lg mt-4 ">
      <span
      ...
      <div className="flex flex-col items-center">
        ...
        <button className="text-xs text-gray-500 border-2 rounded-lg py-1 px-2 mt-3 hover:bg-slate-900 hover:text-white">
          {btn}
        </button>
      </div>
    </div>
